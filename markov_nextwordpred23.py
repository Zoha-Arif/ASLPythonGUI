...
while(True):  #stop when user preses enter
    ...
    if(c==''):
        ...
        if(len(tkns) < 2):  #only first space encountered yet
            ...
            #sys.stdout.write(str(last_suggestion))
            #process.stdout.write(str(last_suggestion))
            #process.stdout.flush()
            #cv2.putText(blackboard, last_suggestion, (30, 150), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 203, 253))
        else: #send a tuple
